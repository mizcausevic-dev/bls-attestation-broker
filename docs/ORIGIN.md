...
**bls-attestation-broker** started from a recurring problem in platform governance: teams had more signal than operational clarity. That difference between visibility and usability kept showing up under pressure.
...
This repo also avoids trying to be a vague platform for everything. Its value comes from being opinionated about a real problem: Multi-signer attestation broker using BLS12-381 aggregate signatures. N signatures collapse into one 96-byte aggregate verifiable in two pairings. Reference impl with textbook BLS; production should use blst.

What comes next is practical. The roadmap is about historical baselines, deeper policy authoring, and stronger export into broader operational review loops. The long-term value of **bls-attestation-broker** is that it makes that operating layer concrete enough to review, improve, and trust.